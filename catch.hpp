...
namespace Catch {
    ...
    public:
        ...
        operator T() const {
            ...
            return T();
            // Suppress spurious "not all control paths return a value" warning in Visual Studio - if you know how to fix this please do so
        }
    ...
    namespace Detail {
        ...
        public:
            ...
            friend bool operator ==(double lhs, Approx const &rhs) {
                ...
                return fabs(lhs - rhs.m_value) < rhs.m_epsilon * (
        ...
        namespace Detail {
            ...
            inline void convertInto(std::string const &_source, bool &_dest) {
                ...
                if (sourceLC == "y" || sourceLC == "1" || sourceLC == "true" || sourceLC == "yes" || sourceLC == "on")
                    _dest = true;
                else if (sourceLC == "n" || sourceLC == "0" || sourceLC == "false" || sourceLC == "no" || sourceLC ==
                         "off")
                    _dest = false;
                else
...
namespace Catch {
    ...
    public:
        ...
        void testGroupEnded(std::string const &testSpec, Totals const &totals, std::size_t groupIndex,
            ...
            m_reporter->
                    testGroupEnded(TestGroupStats(GroupInfo(testSpec, groupIndex, groupsCount), totals, aborting()));
        }
    ...
    private: // IResultCapture
        ...
        virtual void sectionEnded(SectionEndInfo const &endInfo) {
            ...
            m_reporter->sectionEnded(SectionStats(endInfo.sectionInfo, assertions, endInfo.durationInSeconds,
                                                  missingAssertions));
            m_messages.clear();
        }
...
namespace Catch {
    ...
    public:
        ...
        virtual IStreamingReporter *create(std::string const &name, Ptr<IConfig const> const &config) const
        CATCH_OVERRIDE {
...
namespace Catch {
    ...
    bool LegacyReporterAdapter::assertionEnded(AssertionStats const &assertionStats) {
        if (assertionStats.assertionResult.getResultType() != ResultWas::Ok) {
            for (std::vector<MessageInfo>::const_iterator it = assertionStats.infoMessages.begin(), itEnd =
                                 assertionStats.infoMessages.end();
                 it != itEnd;
                 ++it) {
...
namespace Catch {
    ...
    std::string ResultBuilder::reconstructExpression() const {
        if (m_exprComponents.op == "")
            ...
            return "{can't expand - use " + m_assertionInfo.macroName + "_FALSE( " + m_assertionInfo.capturedExpression.
